...
void ShowField(bool ShowOpponent, bool OpponentShipsVisible) {
	...
	cout << "\t   You"; if (ShowOpponent) { cout << "\t\t\t   Oponente"; }
...
void TextDuringPlayerPlacing() {
	...
	setColor(4, 15); cout << "  BUQUES DE BATALLA  ";
	setColor(0, 15); cout << (char)215 << (char)183 << "_";

	gotoxy(30, 3);
	cout << "Ahora es tu turno de colocar barcos en el campo";
	gotoxy(40, 6);
	...
	setColor(0, 15); cout << " para reubicar el barco, ";
	setColor(2, 15); cout << "R";
	setColor(0, 15); cout << " to rorate";
	gotoxy(30, 20);
	cout << "and ";
	setColor(2, 15); cout << "Enter ";
	setColor(0, 15); cout << "para colocar un barco";
	gotoxy(30, 22);
	cout << "O tipo "; setColor(12, 15); cout << "restablecimiento"; setColor(0, 15); cout << "  Para restablecer el campo";
}
...
void TextDuringGame() {
	...
	gotoxy(54, 4);
	cout << "Tus barcos se fueron: " << playerShipsLeft;
	gotoxy(54, 6);
	cout << "Barcos oponentes a la izquierda: " << opponentShipsLeft;
	gotoxy(54, 8); cout << "-";
	gotoxy(54, 10); setColor(2, 15); cout << "W A S D "; setColor(0, 15); cout << "para mudanzas";
	gotoxy(54, 12); setColor(2, 15); cout << "Enter "; setColor(0, 15); cout << "para rodajes";
}
...
void winScreen(bool win) {
	...
	if (rows < 5 || score > scores[4]) {
		cursorVisible(true);
		gotoxy(0, 22);
		cout << "\t\t      Introduce tu nombre para guardar la puntuación: ";
		string player;
		int playerScore;
		cin >> player;
		gotoxy(0, 22); cout << "\t\t\t\t\t\t\t\t\t"; gotoxy(0, 22);
		setColor(2, 15); cout << "\t\t\t\t     Guardar!"; setColor(0, 15);
		playerScore = score;
		cursorVisible(false);
